...
const R = `${base}valle-peligna/`;

const issues = {
  2004: [
    {
      label: "Summer-Autumn 2004",
      pdf: `${R}vp_summerAutumn_2004.pdf`,
      metadata: {
    ...
    },
    {
      ...
      pdf: `${R}vp_summerAutumnBlue_2004.pdf`,
      metadata: {
...
export default function VallePeligna() {
  ...
  // Prevent the main page from scrolling while the popup is open
  useEffect(() => {
    if (viewing) {
      ...
      <div className="ornamental-border bg-[#f5f0e8] p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-8 mb-8">
          ...
          <div className="flex-1">
            ...
            >
              The Valle Peligna is hosted by the ICAP-London webpage, in fair
              dealing and with the purpose of preserving the stories and the
              voices of the Italian-Canadian community of London, thus
              contributing to documenting the history of Canada at large.
            </p>
            ...
            >
              ...
              <p>
                <strong>Years Available:</strong> 2004 – 2005
              </p>
            </div>
          </div>
        </div>
        ...
        {viewing && (
          ...
          >
            ...
            >
              ...
              {/* Inner content keeps PDF narrower */}
              <div
                style={{
                  width: "90%",
                  margin: "0 auto",
        ...
        >
          ...
          intellectual rights and to receive permission to make this publication
          available through our site. Should you feel that your rights have been
          infringed by any material, please contact us and we will remove the
          content concerned.
        </p>
      </div>
    </PageLayout>
